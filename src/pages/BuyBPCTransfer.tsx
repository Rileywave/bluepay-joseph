...
const BuyBPCTransfer = () => {
  ...
  const email = "bluepaywebservice@gmail.com";
    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="bg-white m-5 p-5 rounded-lg border border-gray-200">
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <div className="flex justify-between items-center">
            <p className="text-2xl font-bold">8151889909</p>
            <Button 
              variant="default" 
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-2"
              onClick={() => handleCopy("8151889909", "Account Number")}
            >
              <Copy size={18} />
              Copy
            </Button>
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <p className="text-2xl font-bold">NNANNA JOSEPH</p>
        </div>
      </div>
